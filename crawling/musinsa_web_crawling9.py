...
for i in brandname:
    ...
    print("찾고하는 브랜드들을 공백을 띄어놓고 입력하세요. ex) a b c")
    choose_brand = list((input("찾고자 하는 브랜드를 입력하세요: ").split()))
    for j in range(3):
...
df = df.loc[["thisisneverthat","musinsastandard","covernat"],main_category ]
# 스타일 서식 지정
